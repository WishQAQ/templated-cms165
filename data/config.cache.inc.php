...
$cfg_cmspath = '';
$cfg_cookie_encode = 'WGC9rRsuwHSbnTHVgisTFELu8oPLcni';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = 'Ê×Ò³';
$cfg_webname = 'Ö¯ÃÎ¸ß¶Ë´óÆø±ÚÇòÅàÑµ»ú¹¹ÍøÕ¾Ô´Âë-Õ¾ÎÑÎÑ';
...
$cfg_specnote = 6;
$cfg_list_symbol = ' > ';
$cfg_notallowstr = '·Çµä|°¬×Ì²¡|Ñôðô';
$cfg_replacestr = 'ËýÂè|ËüÂè|ËûÂè|ÄãÂè|È¥ËÀ|¼úÈË';
$cfg_feedbackcheck = 'N';
...
$dede_powerby = '<span>°æÈ¨ËùÓÐ£ºÕ¾ÎÑÎÑ</span>';
$dede_leftcontact = '<div class="cp">±ÚÇòÅàÑµ×ÉÑ¯£º<br />TEL£º123456678        </div>
<div class="cp1"></div>';
$dede_nyleftcontact = '<div class="cp">±ÚÇòÅàÑµ×ÉÑ¯£º<br />TEL£º123456678         </div>
<div class="cp1"></div>';
?>